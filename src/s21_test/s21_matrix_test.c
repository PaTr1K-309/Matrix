...
START_TEST(s21_create_matrix_10) {
  //   matrix_t A = {0};
  //   int size = 46340;
  // //46340 может выделить
  // //46341 не может выделить
  // //32 оперы
  //   int res = s21_create_matrix(size, size, &A);

  //   // s21_remove_matrix(&A);
  //   ck_assert_int_eq(res, ALLOCATION_ERROR);
}
END_TEST
...
START_TEST(s21_sum_matrix_08) {
  ...
  ck_assert_int_eq(res, ERROR_CALCULATE);
}
END_TEST
...
START_TEST(s21_inverse_matrix_02) {
  ...
  ck_assert_int_eq(Z.matrix[0][0] == (1.0 / A.matrix[0][0]), SUCCESS);
...
Suite *test() {
  ...
  s = suite_create("test");
  tc_test_1 = tcase_create("s21_test");
  suite_add_tcase(s, tc_test_1);

  tcase_add_test(tc_test_1, s21_create_matrix_01);
  tcase_add_test(tc_test_1, s21_create_matrix_02);
  tcase_add_test(tc_test_1, s21_create_matrix_03);
  tcase_add_test(tc_test_1, s21_create_matrix_04);
  tcase_add_test(tc_test_1, s21_create_matrix_05);
  tcase_add_test(tc_test_1, s21_create_matrix_06);
  tcase_add_test(tc_test_1, s21_create_matrix_07);
  tcase_add_test(tc_test_1, s21_create_matrix_08);
  tcase_add_test(tc_test_1, s21_create_matrix_09);
  tcase_add_test(tc_test_1, s21_create_matrix_10);

  tcase_add_test(tc_test_1, s21_remove_matrix_01);
  tcase_add_test(tc_test_1, s21_remove_matrix_02);
  tcase_add_test(tc_test_1, s21_remove_matrix_03);
  tcase_add_test(tc_test_1, s21_remove_matrix_04);
  tcase_add_test(tc_test_1, s21_remove_matrix_05);

  tcase_add_test(tc_test_1, s21_eq_matrix_01);
  tcase_add_test(tc_test_1, s21_eq_matrix_02);
  tcase_add_test(tc_test_1, s21_eq_matrix_03);
  tcase_add_test(tc_test_1, s21_eq_matrix_04);
  tcase_add_test(tc_test_1, s21_eq_matrix_05);
  tcase_add_test(tc_test_1, s21_eq_matrix_06);

  tcase_add_test(tc_test_1, s21_sum_matrix_01);
  tcase_add_test(tc_test_1, s21_sum_matrix_02);
  tcase_add_test(tc_test_1, s21_sum_matrix_03);
  tcase_add_test(tc_test_1, s21_sum_matrix_04);
  tcase_add_test(tc_test_1, s21_sum_matrix_05);
  tcase_add_test(tc_test_1, s21_sum_matrix_06);
  tcase_add_test(tc_test_1, s21_sum_matrix_07);
  tcase_add_test(tc_test_1, s21_sum_matrix_08);
  tcase_add_test(tc_test_1, s21_sum_matrix_09);
  tcase_add_test(tc_test_1, s21_sum_matrix_10);

  tcase_add_test(tc_test_1, s21_sub_matrix_01);
  tcase_add_test(tc_test_1, s21_sub_matrix_02);
  tcase_add_test(tc_test_1, s21_sub_matrix_03);
  tcase_add_test(tc_test_1, s21_sub_matrix_04);
  tcase_add_test(tc_test_1, s21_sub_matrix_05);
  tcase_add_test(tc_test_1, s21_sub_matrix_06);
  tcase_add_test(tc_test_1, s21_sub_matrix_07);
  tcase_add_test(tc_test_1, s21_sub_matrix_08);
  tcase_add_test(tc_test_1, s21_sub_matrix_09);
  tcase_add_test(tc_test_1, s21_sub_matrix_10);

  tcase_add_test(tc_test_1, s21_mult_number_01);
  tcase_add_test(tc_test_1, s21_mult_number_02);
  tcase_add_test(tc_test_1, s21_mult_number_03);
  tcase_add_test(tc_test_1, s21_mult_number_04);
  tcase_add_test(tc_test_1, s21_mult_number_05);
  tcase_add_test(tc_test_1, s21_mult_number_06);

  tcase_add_test(tc_test_1, s21_mult_matrix_01);
  tcase_add_test(tc_test_1, s21_mult_matrix_02);
  tcase_add_test(tc_test_1, s21_mult_matrix_03);
  tcase_add_test(tc_test_1, s21_mult_matrix_04);
  tcase_add_test(tc_test_1, s21_mult_matrix_05);
  tcase_add_test(tc_test_1, s21_mult_matrix_06);
  tcase_add_test(tc_test_1, s21_mult_matrix_07);
  tcase_add_test(tc_test_1, s21_mult_matrix_08);

  tcase_add_test(tc_test_1, s21_transpose_01);
  tcase_add_test(tc_test_1, s21_transpose_02);
  tcase_add_test(tc_test_1, s21_transpose_03);

  tcase_add_test(tc_test_1, s21_determinant_01);
  tcase_add_test(tc_test_1, s21_determinant_02);
  tcase_add_test(tc_test_1, s21_determinant_03);
  tcase_add_test(tc_test_1, s21_determinant_04);
  tcase_add_test(tc_test_1, s21_determinant_05);
  tcase_add_test(tc_test_1, s21_determinant_06);

  tcase_add_test(tc_test_1, s21_calc_complements_01);
  tcase_add_test(tc_test_1, s21_calc_complements_02);
  tcase_add_test(tc_test_1, s21_calc_complements_03);
  tcase_add_test(tc_test_1, s21_calc_complements_04);
  tcase_add_test(tc_test_1, s21_calc_complements_05);

  tcase_add_test(tc_test_1, s21_inverse_matrix_01);
  tcase_add_test(tc_test_1, s21_inverse_matrix_02);
  tcase_add_test(tc_test_1, s21_inverse_matrix_03);
  tcase_add_test(tc_test_1, s21_inverse_matrix_04);
  tcase_add_test(tc_test_1, s21_inverse_matrix_05);
  tcase_add_test(tc_test_1, s21_inverse_matrix_06);
